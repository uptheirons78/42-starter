 ...
 */
define('LOGO_FILE', '42digital-logo.png');
define('BACKGROUND_FILE', 'background.svg');
...
{ ?>
  <style type="text/css">
    ...
    .login {
      min-height: 100%;
      background: linear-gradient(0deg, rgba(0, 0, 0, 0.1), rgba(0, 0, 0, 0.1)), url("<?php echo BACKGROUND; ?>");
